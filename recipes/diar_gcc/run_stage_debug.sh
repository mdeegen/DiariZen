...
export train_conf=$conf_dir/gcpsd_encoder_bce_debug.toml # gcc_encoder_precomputed  baseline_sc_debug.toml   #    mc_wavlm_updated_conformer.toml #MC
# TODO:  GCC PFAD in pyannote: EVAL standard_gcc, muss auch für base angepasst werden
# TODO:  GCC PFAD in pyannote: EVAL standard_gcc, muss auch für base angepasst werden
# gcc_encoder_4096_wof_nll_loss initial_4096 initial_4096_no_chime gcc_encoder_standard_gcc gcc_encoder_4096_wof_solo gcpsd_encoder_1024_wof
...
############            ### Debugguing: use only one GPU and worker
        micromamba activate diarizen && CUDA_VISIBLE_DEVICES="5" accelerate launch \
