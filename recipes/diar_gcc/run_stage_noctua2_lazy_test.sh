...
#            run_dual_opt_mc_lazy_test.py -C $train_conf -M train $resume_flag
...
#        source  /pc2/groups/hpc-prf-nt1/deegen/venvs/diarizen/bin/activate && python infer_avg_oracle.py -C $config_dir \
