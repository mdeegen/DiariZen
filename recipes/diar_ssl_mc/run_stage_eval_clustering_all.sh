...
export train_conf=$conf_dir/spk_count_linear_noisy_to_gcpsd_encoder_ffn_film_all_layers.toml # gcc_encoder_precomputed  baseline_sc_debug.toml   #    mc_wavlm_updated_conformer.toml #MC
