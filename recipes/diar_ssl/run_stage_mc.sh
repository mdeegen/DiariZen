...
# train_conf=$conf_dir/sc_sdm_ft_from_8compounds.toml
# train_conf=$conf_dir/mc_channel_att_ft_from_8compounds.toml
# train_conf=$conf_dir/mc_channel_att_ft_base_s80_preheat_freeze_wavlm_5ep.toml
# train_conf=$conf_dir/mc_channel_att_ft_base_s80_preheat_freeze_wavlm_0ep_ln_skip_connection.toml
# train_conf=$conf_dir/mc_tac_ft_base_s80.toml
# train_conf=$conf_dir/mc_channel_att_preLN_dropout_ft_base_s80.toml

# train_conf=$conf_dir/mc_channel_att_preLN_dropout_conv_spatialnet_ft_base_s80.toml

train_conf=$conf_dir/mc_channel_att_grc_1linear_ft_base_s80.toml
...
if [ $stage -le 2 ]; then
    ...
    for dset in   AliMeeting CHiME7 NOTSOFAR1 AMI AISHELL4; do
        ...
        conda activate diarizen && python infer_avg_mc_oracle.py -C $config_dir \
