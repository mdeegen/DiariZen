...
def run(config, resume):
    ...
    if "train" in args.mode:
        ...
        train_dataloader = DataLoader(
            dataset=train_dataset, collate_fn=collate_fn_partial, prefetch_factor=2, shuffle=True, **config["train_dataset"]["dataloader"]
        )
    ...
    if "train" in args.mode or "validate" in args.mode:
        ...
        validate_dataloader = DataLoader(
            dataset=validate_dataset, collate_fn=collate_fn_partial, prefetch_factor=2, shuffle=False, **config["validate_dataset"]["dataloader"]
        )
