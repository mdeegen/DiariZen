...
from diarizen.models.module.conformer import ConformerEncoder, gcc_encoder, init_as_identity, gcc_encoder_cnn_tac_small
...
class Model(BaseModel):
    def __init__(
        ...
        self.gcc_encoder = gcc_encoder_cnn_tac_small(
            cnn_out=cnn_out,
        ...
        self.proj = nn.Linear(cnn_out, attention_in)
