...
from diarizen.models.module.conformer import ConformerEncoder, FiLM, gcc_encoder
...
class Model(BaseModel):
    ...
    def forward(self, gcc_features, num_spk) -> torch.Tensor:
        """Pass forward
        ...
        """
        # assert gcc_features.dim() == 3, f'waveforms.dim() = {waveforms.dim()}, should be 3, shape: {waveforms.shape}'
        assert num_spk.dim() == 3, f'num_spk.dim() = {num_spk.dim()}, should be 3, shape: {num_spk.shape}'
