...
class Model(BaseModel):
    def __init__(
        ...
        self.conformer = ConformerEncoder(
            attention_in=attention_in + 4,  # +1 for num_spk
        ...
        self.classifier = nn.Linear(attention_in + 4, self.dimension)
    ...
    def forward(self, waveforms: torch.Tensor, num_spk) -> torch.Tensor:
        """Pass forward
        ...
        outputs = torch.cat((outputs, num_spk, num_spk, num_spk, num_spk), dim=-1)  # (batch, frames, attention_in + 4)
