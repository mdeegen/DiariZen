...
from diarizen.models.module.conformer import ConformerEncoder, FiLM, ConformerEncoder_film_deep
...
class Model(BaseModel):
    def __init__(
        ...
        if self.film_layers:
            self.conformer = ConformerEncoder_film_deep(
        ...
        # for param in self.gcc_encoder.parameters():
    ...
    def forward(self, waveforms: torch.Tensor, gcpsd_features) -> torch.Tensor:
        ...
        # with torch.no_grad():
        gcpsd_emb = self.gcc_encoder(waveforms, gcpsd_features)
