...
from diarizen.models.module.conformer import ConformerEncoder, gcc_encoder_magnitude_attention, init_as_identity
...
class Model(BaseModel):
    def __init__(
        ...
        self.gcc_encoder = gcc_encoder_magnitude_attention(
