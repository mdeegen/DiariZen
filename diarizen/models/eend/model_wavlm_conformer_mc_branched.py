...
class Model(BaseModel):
    def __init__(
        ...
        ###############################################
        # second branch for gcc features
        self.conformer_gcc = ConformerEncoder(
            attention_in=attention_in,
            ffn_hidden=ffn_hidden,
            num_head=num_head,
            num_layer=num_layer,
        ...
        # TODO: Statt nur linear hier, vielleicht attention cross attention oder so machen? wie hier mergen?
    ...
    def forward(self, waveforms: torch.Tensor, gcc_features=None) -> torch.Tensor:
        ...
        gcc_embeddings = self.conformer_gcc(gcc_embeddings)
