...
# TODO: alle params übernehmen und übergeben für prob gcpsd
...
class Model(BaseModel):
    def __init__(
        ...
        self.merge_linear = nn.Linear(attention_in + max_num_spk, attention_in)
        self.max_num_spk = max_num_spk
        if film:
            self.film = FiLM(attention_in, max_num_spk)
