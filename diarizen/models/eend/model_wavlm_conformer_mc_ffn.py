...
from diarizen.models.module.conformer import ConformerEncoder, gcc_encoder_f, init_as_identity
...
class Model(BaseModel):
    def __init__(
        ...
        linear_output_size: int = 200,  # number of frames per channel
        num_head_aux: int = 4,
        num_layer_aux: int = 2,
        ffn_hidden: int = 1024,
        num_head: int = 4,
        ...
        self.gcc_encoder = gcc_encoder_f(
        ...
        init_as_identity(self.merged_linear) # takes smaller dim, so identity for attention in and rest is zeros
