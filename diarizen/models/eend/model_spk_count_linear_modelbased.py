...
from diarizen.models.encoder_only.spk_counting_modelbased import Model as spk_counting
...
class Model(BaseModel):
    ...
    def forward(self, waveforms: torch.Tensor, gcc_features) -> torch.Tensor:
        ...
        if self.median:
            num_spk = self.median_filter_torch(num_spk, kernel_size=25, f=self.median)
