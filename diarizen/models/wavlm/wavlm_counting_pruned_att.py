...
class Model(BaseModel):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            max_speakers_per_frame=2 if powerset else None,)
        ...
        if shared_wavlm_model is not None:
            self.wavlm_model = shared_wavlm_model
        else:
            self.wavlm_model = self.load_wavlm("wavlm_base_s80_md")
        print(f"WavLM loaded from wavlm_base_s80_md")
